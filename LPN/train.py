...
parser.add_argument('--use_mask', action='store_true', help='apply patch mask')
...
if opt.use_mask:
    ...
    transform_train_list.append(mask) # 对 street/drone 掩码
transform_train_list.append(transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225]))

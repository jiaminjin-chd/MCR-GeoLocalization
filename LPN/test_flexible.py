...
parser.add_argument('--gallery', default='gallery_satellite', type=str)
parser.add_argument('--query', default='query_drone', type=str)
...
gallery_name = opt.gallery
query_name = opt.query
#gallery_name = 'gallery_street'
